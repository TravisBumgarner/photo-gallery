    ...
    return (
        ...
        >
                                ...
                                return (
                                    <Select
                                        ...
                                        onChange={(e) => {
                                            ...
                                            const newFolder = parentPath ? `${parentPath}/${picked}` : picked;
                                            onFilterChange({ folder: newFolder });
                                        }}
                                        sx={{ '& .MuiSelect-select': { py: 0, typography: 'body2', fontWeight: 'bold' } }}
                                    >
                                        {siblings.map((sib) => (
                                            <MenuItem key={sib} value={sib}>{sib}</MenuItem>
                                        ))}
                                    </Select>
                                );
                            }
                        ...
                        <FormControl size="small" sx={{ minWidth: 120 }}>
                            <Select
                                ...
                                onChange={(e) => {
                                    ...
                                    if (child) {
                                        const newFolder = currentFolder ? `${currentFolder}/${child}` : child;
                                        onFilterChange({ folder: newFolder });
                                    }
                                }}
                                renderValue={() => (
            ...
            <Stack direction="row" spacing={3} alignItems="center" sx={{ mt: 1 }}>
                {/* Color Label */}
                <Stack direction="row" spacing={0.5} alignItems="center">
                    <Typography variant="caption" fontWeight="600" sx={{ mr: 0.5 }}>Color</Typography>
                    <Box
                ...
                {/* Rating */}
                <Stack direction="row" spacing={0.5} alignItems="center">
                    <Typography variant="caption" fontWeight="600" sx={{ mr: 0.5 }}>Rating</Typography>
                    <Chip
                        label="All"
                        size="small"
                ...
                {isoValues.length > 0 && (
                    <Stack direction="row" spacing={1} alignItems="center" sx={{ flexGrow: 1 }}>
                        <Typography variant="caption" fontWeight="600">ISO</Typography>
                        <Slider
                            value={isoRange || [
                ...
                {apertureValues.length > 0 && (
                    <Stack direction="row" spacing={1} alignItems="center" sx={{ flexGrow: 1 }}>
                        <Typography variant="caption" fontWeight="600">Aperture</Typography>
                        <Slider
                            value={apertureRange || [
